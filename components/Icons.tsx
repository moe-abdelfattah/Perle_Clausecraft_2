...
export const PerleLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path 
            fillRule="evenodd" 
            clipRule="evenodd" 
            d="M12 0C17.3333 8 17.3333 8 24 12C17.3333 16 17.3333 16 12 24C6.66667 16 6.66667 16 0 12C6.66667 8 6.66667 8 12 0ZM12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z"
        />
    </svg>
);

export const DocumentStackIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const AgreementIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const ClausecraftHeroIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const PdfFileIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <polyline points="14 2 14 8 20 8" />
        <path d="M9 14h1v4" />
        <path d="M9 18h1.5a1.5 1.5 0 0 0 0-3H9" />
        <path d="M13 18h1a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2h-1v6z" />
        <path d="M17 18h1.5a.5 .5 0 0 0 .5-.5v-4a.5 .5 0 0 0-.5-.5H17" />
    </svg>
);

export const MarkdownFileIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
        <polyline points="14 2 14 8 20 8" />
        <path d="M9 15v-4l2 2 2-2v4" />
        <path d="M17 15l-2.5-2.5" />
        <path d="M17 12.5v2.5h-2.5" />
    </svg>
);

export const TxtFileIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
        <polyline points="14 2 14 8 20 8" />
